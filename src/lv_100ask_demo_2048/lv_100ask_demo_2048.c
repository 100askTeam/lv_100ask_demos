...
static void play_2048_event_cb(lv_obj_t * obj, lv_event_t e);
...
static void initBoard(lv_obj_t * parent, uint8_t board[SIZE][SIZE])
{
	...
	lv_obj_t * best_source_canvas = lv_canvas_create(lv_scr_act());
	...
	lv_obj_t *  current_source_canvas = lv_canvas_create(lv_scr_act());
	...
	lv_obj_t * game_title = lv_label_create(lv_scr_act());
...
#if 1
	lv_obj_t * game_tutorial = lv_label_create(lv_scr_act());
							 ...
							 lv_color_t rgb32)
{
    ...
    lv_style_set_text_font(&style_icon, &lv_font_montserrat_48);  /*Set a larger font*/
...
void lv_100ask_demo_2048(void)
{
	...
	game_2048_canvas = lv_canvas_create(lv_scr_act());
	...
	lv_obj_add_event_cb(lv_scr_act(), play_2048_event_cb, LV_EVENT_CLICKED,  NULL);
